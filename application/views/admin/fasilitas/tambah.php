               ...
               <div class="col-md-7">
                  <div class="panel panel-primary">
                     ...
                     <div class="panel-body">
                        <?= form_open_multipart('admin/fasilitas/tambah') ?>
                        <div class="form-group">
                           <label>Nama Fasilitas</label>
                           <input type="text" name="nama_fasilitas" class="form-control" placeholder="Nama Fasilitas" value="<?= set_value('nama_fasilitas') ?>" autofocus>
